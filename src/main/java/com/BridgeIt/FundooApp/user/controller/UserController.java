...
public class UserController {
	...
	public ResponseEntity<Response> register(@Valid @RequestBody UserDto userDto, HttpServletRequest httpServletRequest) {
...
Response response = new Response(HttpStatus.OK.value(),messege, "");
	...
	Response response = new Response(HttpStatus.OK.value(),token, "");
	...
	public ResponseEntity<Response> restpassword(@Valid @PathVariable String token,
